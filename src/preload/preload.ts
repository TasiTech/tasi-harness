...
const api = {
  ...
  sessions: {
    ...
    listPage: (req?: SessionListPageRequest) => ipcRenderer.invoke('sessions:listPage', req),
  ...
  skills: {
    ...
    browseMarketplace: (req?: string | MarketplaceBrowseRequest) => ipcRenderer.invoke('skills:market:browse', req),
  ...
  dshSidecar: {
    status: () => ipcRenderer.invoke('dsh-sidecar:status'),
    start: () => ipcRenderer.invoke('dsh-sidecar:start'),
    stop: () => ipcRenderer.invoke('dsh-sidecar:stop'),
    listPlugins: () => ipcRenderer.invoke('dsh-sidecar:plugins:list'),
    runtimeStatus: () => ipcRenderer.invoke('dsh-sidecar:runtime:status'),
    syncRuntime: () => ipcRenderer.invoke('dsh-sidecar:runtime:sync'),
    listClientMounts: () => ipcRenderer.invoke('dsh-sidecar:client-mounts:list'),
    openClientMount: (req: DshSidecarClientMountOpenRequest) => ipcRenderer.invoke('dsh-sidecar:client-mounts:open', req),
    chatRun: (req: DshSidecarChatRunRequest) => ipcRenderer.invoke('dsh-sidecar:chat:run', req),
    installPlugin: (req: DshSidecarPluginInstallRequest) => ipcRenderer.invoke('dsh-sidecar:plugins:install', req),
    uploadPlugin: (req: DshSidecarPluginUploadRequest) => ipcRenderer.invoke('dsh-sidecar:plugins:upload', req),
    enablePlugin: (req: DshSidecarPluginActionRequest) => ipcRenderer.invoke('dsh-sidecar:plugins:enable', req),
    disablePlugin: (req: DshSidecarPluginActionRequest) => ipcRenderer.invoke('dsh-sidecar:plugins:disable', req),
    uninstallPlugin: (req: DshSidecarPluginActionRequest) => ipcRenderer.invoke('dsh-sidecar:plugins:uninstall', req)
  },
  plugins: {
    browseMarketplace: (req?: string | DshMarketplaceBrowseRequest) => ipcRenderer.invoke('plugins:market:browse', req),
    readMarketplacePlugin: (id: string) => ipcRenderer.invoke('plugins:market:detail', id),
    installFromMarketplace: (req: DshMarketplacePluginInstallRequest) => ipcRenderer.invoke('plugins:market:install', req)
  },
  browserCoach: {
  ...
  app: {
    ...
    artifactPreview: (req: ArtifactPreviewRequest) => ipcRenderer.invoke('app:artifactPreview', req) as Promise<ArtifactPreviewResult>,
    openArtifact: (req: ArtifactPathRequest) => ipcRenderer.invoke('app:openArtifact', req),
    revealArtifact: (req: ArtifactPathRequest) => ipcRenderer.invoke('app:revealArtifact', req),

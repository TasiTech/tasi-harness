...
- Reason: Initial checkpoint; final status requires document generation and validation.

## Source Files
- Tender extraction:
  - `C:\Users\hujuntao\.tasi-harness\skills\work\bid-writer\SKILL.md`
- Material roots:
  - `C:\Users\hujuntao\.tasi-harness\skills\work\bid-writer` exists=True

## Tender Order And Format Signals
...
## Mandatory / Starred / Rejection-Risk Signals
...
| Category | Found count | Bid placement/action |
|---|---:|---|
| uncategorized | 12 | Map to tender section before drafting |

## Evidence Image Map
| Image/evidence file | Category | Target section | Embedded? |
|---|---|---|---|
| (no image files inventoried) | - | - | No |

## Section Gates
- [ ] Tender-required document order is locked before drafting.
- [ ] Tender-defined forms/tables are reproduced before content is filled.
- [ ] Every scoring item maps to a response section and evidence.
- [ ] Every mandatory/starred/rejection-risk item maps to a response section and evidence.
- [ ] Every available evidence image is mapped and embedded in the body.
- [ ] Price/quotation fields are real values, not placeholders.
- [ ] Final DOCX passes validate_bid_package.py or is explicitly delivered as Draft/Blocked.

## Missing / Blocked Items
- Record each missing item only after material search is attempted.
